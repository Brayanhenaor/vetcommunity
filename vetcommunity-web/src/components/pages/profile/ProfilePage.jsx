...
import { ModeEditIcon } from "@mui/icons-material";
...
export const ProfilePage = () => {
  ...
  const response = getAsync(endpoints.profile);
  ...
  return (
    <>
      <Container>
        <Grid container sx={{ fontFamily: "Raleway" }} justifyContent="center">
          ...
          <Grid container justifyContent="center" item xs={12}>
            <span style={{ textAlign: "center" }}>danielr5283@gmail.com</span>
          </Grid>
